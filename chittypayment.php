...
<head>
  ...
  <!-- Div for login section -->
	...
	<form method="post" name="myform" action="#">
			...
			<tr><td><h3>CHITTY PAYMENT</h3></td></tr>
	...
	<tr><td> NAME:</td> <td><input type="text" id="cname"></td></tr></br><tr></tr> 
	<tr><td> ADDRESS:</td> <td><input type="text" id="caddr"></td></tr></br><tr></tr>
	<tr><td> PHONE:</td> <td><input type="text" id="cmob" maxlength="10" ></td></TR></br></tr><tr></tr>
