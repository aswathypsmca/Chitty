...
?>
	 ...
	 <table >
		...
		<tr><td><button class="button" name="submit" style="margin-left:40%;">EDIT</button></td><td ><button class="button" name="submit" value="reset"style="margin-left:50%;">CANCEL</button></td></tr><tr></tr>
				&nbsp&nbsp</table>
